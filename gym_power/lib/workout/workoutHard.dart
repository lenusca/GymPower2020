...
class WorkoutHard extends StatefulWidget {
  final userID;

  WorkoutHard({Key key, this.userID}) : super(key: key);

  @override
  _WorkoutHardState createState() => _WorkoutHardState();
}

class _WorkoutHardState extends State<WorkoutHard> {
        ...
        child: Row(
          ...
          children: <Widget>[
            Align(
              ...
              child: doc[i].data['image']==null?Container():SizedBox(width: 120, height: 170, child: Image.network(doc[i].data['image']),),
            ),
            Container(
              width: 210,
              height: 170,
    ...
    return Scaffold(
        body: StreamBuilder<QuerySnapshot>(
            stream: Firestore.instance.collection('Exercicio')
                .where('nivel', isEqualTo: 'hard').snapshots(),
